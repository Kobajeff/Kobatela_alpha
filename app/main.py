...
from app.core import database as db         # <-- importe le module
...
# Compatible avec tests: app.router.startup()
@app.on_event("startup")
def startup_event() -> None:
    db.init_engine()                        # <-- sync
    # IMPORTANT: utiliser le moteur DU MODULE, pas la variable importée
